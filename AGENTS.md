# English Pupil’s Book Standard Three — ADT Bundle Reference
...
**English Pupil’s Book Standard Three** — This is a Tanzanian primary English textbook for Standard Three, roughly aimed at children aged about 8–9, published by the Tanzania Institute of Education and written in English. It introduces core language skills through eight units on listening, speaking, reading and writing, covering topics such as pronouns, possession, daily routines, ongoing actions, conjunctions, syllables and pronunciation. The book uses a highly structured, activity-based approach with songs, dialogues, pictures, oral practice and short reading passages, reflecting a practical, competency-based method rooted in everyday school and home life in Tanzania.
...
├── ENGLISH-STD-3-PB--2023-.db                    # SQLite database (pipeline state)
├── ENGLISH-STD-3-PB--2023-.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im003": "Certificate of Approval from the United Republic of Tanzania Ministry of Education, Science and Technology for English Pupil’s Book Standard Three, certificate number 1210, approved on 1 November 2023 and signed by Dr Lyabwene M. Mtahabwa, Commissioner for Education.",
  "gl001": "according to",
  "gl001_def": "following something or matching something",
  "qz001_que": "What does a pronoun replace?",
  "qz001_o0": "1) a song",
  "qz001_o0_exp": "❌ Not quite. A song can help you learn, but a pronoun does not replace a song."
}
```
...
```json
{
  "according to": {
    "word": "according to",
    "definition": "following something or matching something",
...
```json
{
  "title": "English Pupil’s Book Standard Three",
  "bundleVersion": "1",
  "languages": {
    "available": [
      "en-GB"
...
<section role="activity" data-section-type="activity_quiz" data-id="qz001"
    ...
    <p data-id="qz001_que">What does a pronoun replace?</p>

    <label data-activity-item="qz001_o0"
           data-explanation="❌ Not quite. A song can help you learn, but a pronoun does not replace a song." data-explanation-id="qz001_o0_exp">
        <input type="radio" name="qz001" value="qz001_o0" class="sr-only" />
        <span data-id="qz001_o0">1) a song</span>
    </label>
    <!-- more options... -->
</section>
...
| Original PDF | `ENGLISH-STD-3-PB--2023-.pdf` |
| Pipeline database | `ENGLISH-STD-3-PB--2023-.db` (SQLite) |
